...
M.human_size = function(size)
  local human = require("auto-finder.neotree.utils.filesize.filesize")(size, { output = "string" })
  ---@cast human string
  return human
end
...
-- USAGE:
--   - `require("auto-finder.neotree.utils").brace_expand("x{a..e..2}")` -> `{ "xa", "xc", "xe" }`
--   - `require("auto-finder.neotree.utils").brace_expand("file.txt{,.bak}")` -> `{ "file.txt", "file.txt.bak" }`
--   - `require("auto-finder.neotree.utils").brace_expand("./{a,b}/{00..02}.lua")` -> `{ "./a/00.lua", "./a/01.lua", "./a/02.lua", "./b/00.lua", "./b/01.lua", "./b/02.lua" }`
