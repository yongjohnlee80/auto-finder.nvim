...
local filter = require("auto-finder.neotree.sources.filesystem.lib.filter")
...
local focus_next_git_modified = function(state, reverse)
  ...
  local _, worktree_info = require("auto-finder.neotree.git").find_existing_worktree(current_path)
