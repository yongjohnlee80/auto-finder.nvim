...
local symbols = require("auto-finder.neotree.sources.document_symbols.lib.symbols_utils")
      ...
      handler = function()
        ...
        vim.api.nvim_create_autocmd("CursorMoved", {
          ...
          callback = function()
            ...
            local commands = require("auto-finder.neotree.sources.document_symbols.commands")
