...
local config = {
  ...
  -- true, false, "/path/to/file.log", use ':lua require("auto-finder.neotree").show_logs()' to show the file.
  ...
  --      require("auto-finder.neotree.sources.filesystem").reset_search()
  --    end
  --  },
  --  {
  --    event = "file_renamed",
  ...
  default_component_configs = {
    ...
    last_modified = {
      ...
      --format = require("auto-finder.neotree.utils").relative_date, -- enable relative timestamps
    },
    created = {
      enabled = false,
      width = 20, -- width of the column
