...
local builtins = {
  none = function()
    return require("auto-finder.neotree.clipboard.sync.base")
  end,
  global = function()
    return require("auto-finder.neotree.clipboard.sync.global")
  end,
  universal = function()
    return require("auto-finder.neotree.clipboard.sync.universal")
  end,
}
