---View — buffers (neo-tree buffers wrapper).
---
...
---`auto-finder.shared.neotree` — this module is just the view
---descriptor.
---
---ADR 0026 Phase 2: moved from `auto-finder.sections.buffers` to
---`auto-finder.views.buffers`. Original path remains valid via
---facade.
---@module 'auto-finder.views.buffers'

local section = require("auto-finder.shared.neotree").build_section({
  name = "buffers",
...
--
-- The base on_focus from neotree.build_section validates the
